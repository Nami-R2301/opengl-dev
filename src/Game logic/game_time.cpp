...
void
Game_time::set_previous_time(const time_point<system_clock, duration<long, std::ratio<1, 1000000000>>> &previous_time_)
{
  this->previous_time = previous_time_;
}

time_point<system_clock, duration<long, std::ratio<1, 1000000000>>> Game_time::get_current_time() const
{
  return this->current_time;
}

void
Game_time::set_current_time(const time_point<system_clock, duration<long, std::ratio<1, 1000000000>>> &current_time_)
{
  this->current_time = current_time_;
}
